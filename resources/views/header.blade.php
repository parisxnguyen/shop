<div id="header">
			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						...
						<li><a href=""><i class="fa fa-home"></i>http://niie.edu.vn</a></li>
						<li><a href=""><i class="fa fa-phone"></i>0938 116 244 – 0934 116 244</a></li>
					</ul>
				</div>
		...
		<div class="header-body">
			<div class="container beta-relative">
				<div class="pull-left">
					<a href="#" id="logo"><img src="source/assets/dest/images/logo-cake.png" width="300px" alt=""></a>
				</div>
				<div class="pull-right beta-components space-left ov">
					<div class="space10">&nbsp;</div>
					<div class="beta-comp">
						<form role="search" method="get" id="searchform" action="{{route('search')}}">
					        <input type="text" value="" name="s" id="s" placeholder="Nhập tên sản phẩm..." />
		...
		<div class="header-bottom" style="background-color: #008080;">
			<div class="container">
				...
				<nav class="main-menu">
					<ul class="l-inline ov">
						...
						<li><a href="{{route('all')}}">Danh sách sản phẩm</a></li>
