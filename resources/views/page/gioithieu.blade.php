			...
			<div class="our-history">
				...
				<div class="history-slider">
					<div class="history-navigation">
						<a data-slide-index="0" href="blog_with_2sidebars_type_e.html" class="circle"><span class="auto-center">2020</span></a>
					...
					<div class="history-slides">
						<div> 
							<div class="row">
							<div class="col-sm-5">
								<img src="source/assets/dest/images/history.png" alt="">
							</div>
							<div class="col-sm-7">
								<h5 class="other-title">Foundation.</h5>
								<p>
									NIIE.
								</p>
			...
			<div class="row">
				...
				<div class="col-sm-2 col-sm-push-2">
					<div class="beta-counter">
						...
						<p class="beta-counter-value timer numbers" data-to="3568" data-speed="2000"></p>
				...
				<div class="col-sm-2 col-sm-push-2">
					<div class="beta-counter">
						...
						<p class="beta-counter-value timer numbers" data-to="258934" data-speed="2000"></p>
				...
				<div class="col-sm-2 col-sm-push-2">
					<div class="beta-counter">
						...
						<p class="beta-counter-value timer numbers" data-to="150" data-speed="2000"></p>
			...
			<div class="row">
				<div class="col-sm-6 wow fadeInLeft">
					<div class="beta-person media">
						...
						<img class="pull-left" src="source/assets/dest/images/person-1.jpg" width="270" height="285" alt="">
				...
				<div class="col-sm-6 wow fadeInRight">
					<div class="beta-person media ">
						...
						<img class="pull-left" src="source/assets/dest/images/person-2.jpg" width="270" height="285" alt="">
